...
// TODO: make sure that this works, and calculates the size of the element that we pass

// export const DisableBrowserSwipe = (elem) => {
//
...
//
//     console.log('touchmove', maxX, maxY) //this.offsetWidth, this.offsetHeight)
//
